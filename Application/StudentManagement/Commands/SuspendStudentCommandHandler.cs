...
{
	public class SuspendStudentCommandHandler : ICommandHandler<SuspendStudentCommand, StudentStatus>
	{
		...
		public async Task<Result<StudentStatus>> Handle(SuspendStudentCommand command)
		{
